...
function Add_Player() {
  ...
  useEffect(() => {
    if (dob) {
      ...
      if (
        monthDiff < 0 || (monthDiff === 0 && today.getDate() < birthDate.getDate())) { age--; } setAge(age);
    }
  }, [dob]); const
    handleChange = (e) => {
  ...
  const handleSubmit = async (e) => {
    ...
    // Add stetus column with value "pending"
    formData.append("status", `pending`);

    try {
      const response = await axios.post(
        `${serverUrl}/add-player`,
        formData,
        {
          headers: {
        ...
        <main className="app-content">
          <div className="row">
            <div className="col-md-12">
              <div className="tile">
                <form className="input_form m-0 needs-validation" noValidate id="form_action" role="form"
                  onSubmit={handleSubmit} enctype="multipart/form-data" autoComplete="off">
                  ...
                  <div className="form_card mt-3 mb-5">
                    <div className="row p-2">
                      ...
                      <div className="form-group col-md-3 mb-4">
                        ...
                        <input type="number" className="form-control form-control-sm" name="adha_num" id="adha_num"
                          value={adha_num} placeholder="Aadhar number" onChange={(e) => {
                      ...
                      <div className="form-group col-md-3 mb-2">
                        ...
                        <input type="text" className="form-control form-control-sm" name="pfnmae" id="pfnmae"
                          value={pfnmae} placeholder="First Name" onChange={(e) => setfname(e.target.value)}
                          required />
                      ...
                      <div className="form-group col-md-3 mb-2">
                        ...
                        <input type="text" className="form-control form-control-sm" name="pmname" id="pmname"
                          value={pmname} placeholder="Middle Name" onChange={(e) => setpmname(e.target.value)}
                          required />
                        <div className="invalid-feedback">
                      ...
                      <div className="form-group col-md-3 mb-2">
                        ...
                        <input type="text" className="form-control form-control-sm" name="plnmae" id="plnmae"
                          value={plnmae} placeholder="Last Name" onChange={(e) => setlname(e.target.value)}
                          required />
                        <div className="invalid-feedback">
                      ...
                      <div className="form-group col-md-3 mb-2">
                        ...
                        <select className="form-control form-control-sm" value={gender} onChange={(e) =>
                      ...
                      <div className="form-group col-md-3 mb-2">
                        ...
                        <select className="form-control form-control-sm" value={bloodGroup} onChange={(e) =>
                      ...
                      <div className="form-group col-md-3 mb-2">
                        ...
                        <input type="email" className="form-control form-control-sm" name="email" id="email" value={email}
                          placeholder="Email ID" onChange={(e) => setEmail(e.target.value)} min="0"
                          required />
                        <div className="invalid-feedback">
                      ...
                      <div className="form-group col-md-6 mb-2">
                        ...
                        <textarea className="form-control form-control-sm" name="player_per_addr" id="player_per_addr"
                          rows="3" placeholder="Enter Permanent Address" value={permanentAddress} onChange={(e) => setPermanentAddress(e.target.value)} required
                        ></textarea>
                        <div className="invalid-feedback">
                      ...
                      <div className="form-group col-md-6 mb-2">
                        <label className="form_lbl">
                          ...
                          <span className="text-danger">*</span>{" "}
                          &nbsp;&nbsp;&nbsp;
                          <input type="checkbox" id="same_per_addr" checked={isSameAsPermanent}
                            onChange={handleSameAsPermanentChange} />{" "}
                          Same as Permanent Address
                        </label>
                        <textarea className="form-control form-control-sm" name="player_cor_addr" id="player_cor_addr"
                          rows="3" placeholder="Enter Correspondence Address" value={isSameAsPermanent ? permanentAddress
                            : correspondenceAddress} onChange={(e) =>
                      ...
                      <div className="form-group col-md-3 mb-2">
                        ...
                        <input type="text" className="form-control form-control-sm" name="player_dob_cer_no"
                          id="player_dob_cer_no" value={dobCertNo} placeholder="Enter DOB Digital Certificate Reg No."
                      ...
                      <div className="form-group col-md-3 mb-2">
                        ...
                        <input type="date" className="form-control form-control-sm datetimepicker-input"
                          name="player_dob_cer_date" id="player_dob_cer_date" value={dobCertDate}
                          placeholder="Enter Issued Date" onChange={(e) => setDobCertDate(e.target.value)}
                          required />
                        <div className="invalid-feedback">
                      ...
                      <div className="form-group col-md-3 mb-2">
                        ...
                        <input type="text" className="form-control form-control-sm" name="player_dob_cer_place"
                          id="player_dob_cer_place" value={dobCertPlace} placeholder="Enter Certificate Issued Place"
                      ...
                      <div className="form-group col-md-3 mb-2">
                        ...
                        <input type="text" className="form-control form-control-sm" name="player_sch_cer_no"
                          id="player_sch_cer_no" value={schoolCertNo} placeholder="Enter School/College Certificate No."
                      ...
                      <div className="form-group col-md-3 mb-2">
                        ...
                        <input type="date" className="form-control form-control-sm datetimepicker-input"
                          name="player_ssc_cer_date" id="player_ssc_cer_date" value={sscCertDate}
                          placeholder="Enter SSC Certificate Date of Issue" onChange={(e) =>
                            setSscCertDate(e.target.value)}
                        />
                        <div className="invalid-feedback">
                      ...
                      <div className="form-group col-md-3 mb-2">
                        ...
                        <input type="text" className="form-control form-control-sm" name="player_father_name"
                          id="player_father_name" value={fatherName} placeholder="Enter Father's Name" onChange={(e) =>
                      ...
                      <div className="form-group col-md-3 mb-2">
                        ...
                        <input type="text" className="form-control form-control-sm" name="player_mother_name"
                          id="player_mother_name" value={motherName} placeholder="Enter Mother's Name" onChange={(e) =>
                      ...
                      <div className="form-group col-md-3 mb-2">
                        ...
                        <input type="text" className="form-control form-control-sm" name="player_guard_name"
                          id="player_guard_name" value={guardianName} placeholder="Enter Guardian Name" onChange={(e) =>
                      ...
                      <div className="form-group col-md-3 mb-2">
                        ...
                        <input type="text" className="form-control form-control-sm" name="player_relation"
                          id="player_relation" value={relationType} placeholder="Enter Relation Type" onChange={(e) =>
                      ...
                      <div className="form-group col-md-3 mb-2">
                        ...
                        <input type="text" className="form-control form-control-sm" name="player_guard_addr"
                          id="player_guard_addr" value={guardianAddress} placeholder="Enter Guardian Address"
...
/>
                      ...
                      <div className="form-group col-md-3 mb-2">
                        ...
                        <input type="date" className="form-control form-control-sm" name="dob" id="dob" value={dob}
                      ...
                      <div className="form-group col-md-3 mb-2">
                        ...
                        <input type="text" className="form-control form-control-sm" name="age" id="age" value={age}
                          readOnly />
                      </div>
                    ...
                    <div className="form-group col-md-6 select_sm mb-2">
                      ...
                      <div className="form-group col-md-4 select_sm mb-2">
                        ...
                        <div className="invalid-feedback">Please select Player Type</div>
                      </div>

                      {/* Show Batting Style and Batting Position for All Rounder and Batsman */}
                      {(playerType === "All Rounder" || playerType === "Batsman") && (
                        <>
                          <div className="form-group col-md-4 select_sm mb-2">
                            <label className="form_lbl">
                              Batting Style<span className="text-danger">*</span>
                            </label>
                            <select
                              className="form-control select2"
                            ...
                            <div className="invalid-feedback">Please select Batting Style</div>
                          </div>

                          <div className="form-group col-md-4 select_sm mb-2">
                            <label className="form_lbl">
                              Batting Position<span className="text-danger">*</span>
                            </label>
                            <select
                              className="form-control select2"
                            ...
                            <div className="invalid-feedback">Please select Batting Position</div>
                          </div>
                        </>
                      )}

                      {/* Show Bowling Style for All Rounder and Bowler */}
                      {(playerType === "All Rounder" || playerType === "Bowler") && (
                        <div className="form-group col-md-4 select_sm mb-2">
                          <label className="form_lbl">
                          ...
                          <div className="invalid-feedback">Please select Bowling Style</div>
                        </div>
                      )}
                      ...
                      <div className="form-group col-md-4 select_sm mb-2">
                        ...
                        <input type="text" className="form-control form-control-sm" name="player_last_assoc"
                          id="player_last_assoc" value={lastAssociation}
                          placeholder="Enter Name of Association Last Represented" onChange={(e) =>
                            setLastAssociation(e.target.value)}
                        />
                        <div className="invalid-feedback">
                      ...
                      <div className="form-group col-md-4 select_sm mb-2">
                        ...
                        <select className="form-control select2" name="player_last_year" id="player_last_year"
                          value={lastYear} onChange={(e) => setLastYear(e.target.value)}
                        >
                  ...
                  <div className="row col-md-12 mt-4">
                    <div className="form-group col-md-4 offset-md-1 mb-2">
                      ...
                      <input type="file" className="form-control form-control-sm" name="adharupload" id="adharupload"
                    ...
                    <div className="form-group col-md-4 mb-2">
                      ...
                      <input type="file" className="form-control form-control-sm" name="Birth_certificate"
                        id="Birth_certificate" onChange={(e) =>
                    ...
                    <div className="form-group col-md-4 offset-md-1 mb-2">
                      ...
                      <input type="file" className="form-control form-control-sm" name="ssc_certificate"
                        id="ssc_certificate" onChange={(e) => setssc_certificate(e.target.files[0])} required
                      />
                    </div>
                    ...
                    <div className="form-group col-md-4 mb-2">
                      ...
                      <input type="file" className="form-control form-control-sm" name="school_lcertificate"
                        id="school_lcertificate" onChange={(e) =>
                    ...
                    <div className="form-group col-md-4 offset-md-1 mb-2">
                      ...
                      <input type="file" className="form-control form-control-sm" name="passport" id="passport"
