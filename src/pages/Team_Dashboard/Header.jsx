...
const handleLogout = async () => {
  ...
  return (
    ...
    <a className="app-header__logo" href="index.html">Ndca</a>
   
    <button className="app-sidebar__toggle" onClick={handleToggle} aria-label="Hide Sidebar"></button>
    <ul className="app-nav">
     
      <li className="dropdown">
        <a className="app-nav__item" href="#" data-bs-toggle="dropdown" aria-label="Open Profile Menu"><i className="bi bi-person fs-4"></i></a>
